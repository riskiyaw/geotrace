...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" name="File Geodatabase Feature Class" type="Local Area Network" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" description="" format="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
